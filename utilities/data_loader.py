...
sys.path.append("/home/lr/faza.thirafi/raid/repository-kenkyuu-models/2024_paper")
...
def get_fc_tensor_dataset(X_inds, args, task, tokenizer, train=False,
    ...
    print("cached_features_file DIR:", cached_features_file)
    ...
    dataset = load_processed_dataset(name, "train")
    print(dataset[0])
